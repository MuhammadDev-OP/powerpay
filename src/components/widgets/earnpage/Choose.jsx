...
const Choose = () => {
    const data = [
        {
            img: '/earnpageelements/card1.svg',
        ...
        {
            img: '/earnpageelements/card2.svg',
        ...
        {
            img: '/earnpageelements/card3.svg',
            title: 'Earn on your own terms',
            text: 'Stay flexible or earn all year round with with Earn+365s 1-year commitment.Select from a range of products that suit your risk profile.'
            ...
            <div className='flex flex-col justify-center items-center py-40 relative'>
                ...
                <div className='z-30'>
                    <h1 className='text-3xl text-center md:text-5xl font-[500] text-white'>
                        Why choose to earn with Powerpay App
                    </h1>
...

                        {
                            data.map((e) => (
                                <div key={e} className='relative max-w-[470px] min-h-[380px] h-full bg-gradient-to-b from-[#1B1B1B] to-[#0E0E0E] flex flex-col justify-center items-center text-center  px-6 rounded-3xl gap-5'>
                                    ...
                                    <div className={` ${e.img == '/earnpageelements/card3.svg' ? '-mt-[20px]' : ''} bg-primary-blue z-20 h-16 w-16 rounded-lg flex items-center justify-center`}>
